...
const mallaCurricular = {
    "Primer Año": {
        ...
        "2 Semestre": [
            ...
            { codigo: "ANAV131", nombre: "EMBRIOLOGIA VETERINARIA", tipo: "obligatoria" }, // Sin prerrequisito
    ...
    "Tercer Año": {
        ...
        "6 Semestre": [
            ...
            { codigo: "MEPR200", nombre: "EPIDEMIOLOGÍA VETERINARIA", tipo: "obligatoria" }, // Sin prerrequisito
...
function renderizarMalla() {
    ...
    for (const year in mallaCurricular) {
        ...
        yearDiv.classList.add('year-container'); // Contenedor para los semestres de un año
